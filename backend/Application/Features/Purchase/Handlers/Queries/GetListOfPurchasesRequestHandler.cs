...
{
    public class GetListOfPurchasesRequestHandler : IRequestHandler<GetListOfPurchasesRequest, PaginatedResult<PurchaseDto>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public GetListOfPurchasesRequestHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
