...
{
    public class GetListWithParamsOfCustomersRequestHandler : IRequestHandler<GetListWithParamsOfCustomersRequest, PaginatedResult<CustomerDto>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public GetListWithParamsOfCustomersRequestHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
        }
        public async Task<PaginatedResult<CustomerDto>> Handle(GetListWithParamsOfCustomersRequest request, CancellationToken cancellationToken)
        {
