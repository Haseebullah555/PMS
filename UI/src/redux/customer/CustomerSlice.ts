...
export const getCustomer = createAsyncThunk('api/Customer/fgh', async (params: any, thunkAPI) => {
  try {
...
// store Customer
export const storeCustomer = createAsyncThunk('api/Customer/store', async (formData: any, thunkAPI) => {
  try {
...
// update user
export const updateCustomer = createAsyncThunk('api/Customer/update', async (formData: any, thunkAPI) => {
  try {
