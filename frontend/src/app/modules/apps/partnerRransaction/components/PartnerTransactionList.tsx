...
import CreateUserModal from './CreatePartnerTransaction'
import EditPartnerTransactionModal from './EditPartnerTransaction'

const PartnerTransactionList = () => {
  const {t} = useTranslation()
  const [isModalOpen, setModalOpen] = useState(false)
  const [isEditModalOpen, setEditModalOpen] = useState(false)
  const [selectedPartnerTransaction, setSelectedPartnerTransaction] = useState(null)

  const closeModal = () => setModalOpen(false)
  const openModal = () => setModalOpen(true)

  const closeEditModal = () => setEditModalOpen(false)
  const openEditModal = (PartnerTransaction: any) => {
  ...
  return (
    <>
          ...
          <div className='card-header cursor-pointer'>
            <div className='card-title m-0'>
              <h3 className='fw-bolder m-0'>
                ...
                {t('global.list', {name: t('partnerTransaction.partnerTransactions')})}
              </h3>
            </div>
            <div>
              <div className='d-none d-lg-flex mt-5'>
                <div className='d-flex align-items-center'>
                  ...
                  >
                    ...
                    {t('global.add', {name: t('partnerTransaction.partnerTransactions')})}
                  </button>
          ...
          <div className='card-body p-9 table-responsive'>
            <DataTable
              ...
              headers={[
                ...
                {
                  headerName: `${t('partner.partner')}`,
                  sort: 'partner',
                },
                {
                  headerName: `${t('partnerTransaction.transactionAmount')}`,
                  sort: 'amount',
                },
                {
                  headerName: `${t('partnerTransaction.transactionType')}`,
              ...
              columns={['id', 'partner', 'amount', 'transactionType', 'date']}
      ...
      {isEditModalOpen && (
        <EditPartnerTransactionModal
          isOpen={isEditModalOpen}
          onClose={closeEditModal}
          selectedPartnerTransaction={selectedPartnerTransaction}
          handleReloadTable={handleReloadTable}
        />
      )}
    </>
