...
import { updateFuelType } from '../../../../../redux/slices/fuelType/FuelTypeSlice'
...
const EditFuelTypeModal: React.FC<EditFuelTypeModalProps> = ({
  ...
  useEffect(() => {
    if (selectedFuelType) {
      ...
      formik.setFieldValue('expenseType', selectedFuelType.expenseType || '')
      formik.setFieldValue('expenseDate', selectedFuelType.expenseDate || '')
      formik.setFieldValue('amount', selectedFuelType.amount || '')
      formik.setFieldValue('notes', selectedFuelType.notes || '')
    }
  }, [selectedFuelType])
  ...
  return (
    <Modal show={isOpen} onHide={onClose} backdrop='static' keyboard={false} size='lg'>
      <Modal.Header closeButton>
        <Modal.Title>{t('global.edit', {name: t('fuelType.fuelTypes')})}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
