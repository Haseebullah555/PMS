...
const DataTable: React.FC<any> = ({ headers, columns, reload, handleEdit }) => {
  ...
  // console.log("FULL STORE:", useAppSelector((state) => state));
                  ...
                  {headers.map((header: any) => (
                    ...
                    >
                      ...
                      {header.sort === sortColumn && (
                        <span>
                          {sortOrder === SORT_ASC ? (
                            <i className='ms-1 fa fa-arrow-up text-white'></i>
                          ) : (
                            <i className='ms-1 fa fa-arrow-down text-white'></i>
                          )}
                        </span>
                      )}
                    </th>
