...
import { updateSupplier } from '../../../../../redux/slices/supplier/SupplierSlice'
...
const EditSupplierModal: React.FC<EditSupplierModalProps> = ({
  ...
  useEffect(() => {
    if (selectedSupplier) {
      ...
      formik.setFieldValue('driverName', selectedSupplier.driverName || '')
      formik.setFieldValue('carPlate', selectedSupplier.carPlate || '')
    }
  }, [selectedSupplier])
