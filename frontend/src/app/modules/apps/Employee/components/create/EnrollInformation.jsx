...
export default function EnrollInformation({
  ...
  const formik = useFormik({
    initialValues: {
      nature_of_employeement_id: employee_selector?.enroll?.nature_of_employeement_id,
      civilian_general_category_id: employee_selector?.enroll?.civilian_general_category_id,
      civilian_grade_category_id: employee_selector?.enroll?.civilian_grade_category_id,
      fastening_determination: employee_selector?.enroll?.fastening_determination,

      military_general_category_id: employee_selector?.enroll?.military_general_category_id,
      military_grade_category_id: employee_selector?.enroll?.military_grade_category_id,
      stabilization_of_rank: employee_selector?.enroll?.stabilization_of_rank,

      nta_general_category_id: employee_selector?.enroll?.nta_general_category_id,
      nta_grade_category_id: employee_selector?.enroll?.nta_grade_category_id,
      nta_start_contract: employee_selector?.enroll?.nta_start_contract,
      nta_end_contract: employee_selector?.enroll?.nta_end_contract,
      contracual_start_contract: employee_selector?.enroll?.contracual_start_contract,
      contracual_end_contract: employee_selector?.enroll?.contracual_end_contract,

      salary: employee_selector?.enroll?.salary,
      job_title: employee_selector?.enroll?.job_title,

      especial_force_point_id: employee_selector?.enroll?.especial_force_point_id,
      mine_clearance_point_id: employee_selector?.enroll?.mine_clearance_point_id,
      cadre_point_id: employee_selector?.enroll?.cadre_point_id,
      medical_specialist_point_id: employee_selector?.enroll?.medical_specialist_point_id,
      education_degree_point_id: employee_selector?.enroll?.education_degree_point_id,
      regional_point_id: employee_selector?.enroll?.regional_point_id,
      right_to_risk_point_id: employee_selector?.enroll?.right_to_risk_point_id,
      satanman_arshad_point: employee_selector?.enroll?.satanman_arshad_point,
      provincial_point_id: employee_selector?.enroll?.provincial_point_id,
    },
    ...
    onSubmit: async (values) => {
      setIsLoading(true)
      dispatch(employeeInformation({data: values, type: 'enroll'}))
                ...
                <div className='col-sm-12 col-md-6'>
                  <div className='row mt-3'>
                    ...
                    <div className='col-sm-12 col-md-6'>
                      ...
                      {formik.touched.nta_grade_category_id &&
        ...
        <div className='row d-flex mt-4 justify-content-between'>
          ...
          >
            {isLoading ? (
              ...
              <span className='fa fa-arrow-right h3'>{/* {SetLang("Back")} */}</span>
            )}
          </button>
          ...
          >
            {isLoading ? (
              ...
              <span className='fa fa-arrow-left h3'>{/* {SetLang("Next")} */}</span>
            )}
          </button>
        </div>
      </form>
