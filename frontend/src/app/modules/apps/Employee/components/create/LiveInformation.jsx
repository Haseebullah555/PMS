...
export default function TazkiraInformation({
  ...
  const formik = useFormik({
    initialValues: {
      parmanent_district_id: employee_selector?.live?.parmanent_district_id,
      parmanent_province_id: employee_selector?.live?.parmanent_province_id,
      parmanent_village: employee_selector?.live?.parmanent_village,
      current_province_id: employee_selector?.live?.current_province_id,
      current_district_id: employee_selector?.live?.current_district_id,
      current_village: employee_selector?.live?.current_village,
    },
    ...
    onSubmit: async (values) => {
      setIsLoading(true)
      dispatch(employeeInformation({data: values, type: 'live'}))
