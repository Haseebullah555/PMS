...
export default function PersonalInformation({
  ...
  const formik = useFormik({
    initialValues: {
      name_da: employee_selector?.personal?.name_da,
      last_name_da: employee_selector?.personal?.last_name_da,
      name_en: employee_selector?.personal?.name_en,
      last_name_en: employee_selector?.personal?.last_name_en,
      father_name: employee_selector?.personal?.father_name,
      grand_father_name: employee_selector?.personal?.grand_father_name,
      gender_id: employee_selector?.personal?.gender_id,
      phone: employee_selector?.personal?.phone,
      birth_date: employee_selector?.personal?.birth_date,
      moi_card_number: employee_selector?.personal?.moi_card_number,
    },
    validationSchema: yup.object().shape({
      ...
      // phone: yup
      //   // .number(SetLang('this field must be a valid phone number'))
      //   .string()
      //   .test(
      //     'is-valid',
      //     SetLang('Invalid phone number'),
