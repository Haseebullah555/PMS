...
import CreateUserModal from './CreateFuelStand'
import EditFuelStandModal from './EditFuelStand'

const FuelStandList = () => {
  const {t} = useTranslation()
  const [isModalOpen, setModalOpen] = useState(false)
  const [isEditModalOpen, setEditModalOpen] = useState(false)
  const [selectedFuelStand, setSelectedFuelStand] = useState(null)

  const closeModal = () => setModalOpen(false)
  const openModal = () => setModalOpen(true)

  const closeEditModal = () => setEditModalOpen(false)
  const openEditModal = (FuelStand: any) => {
    setSelectedFuelStand(FuelStand)
    ...
    <>
      ...
      {isEditModalOpen && (
        <EditFuelStandModal
          ...
          selectedFuelStand={selectedFuelStand}
          handleReloadTable={handleReloadTable}
        />
      )}
    </>
