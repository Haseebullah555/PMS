...
const EditFuelStandModal: React.FC<EditFuelStandModalProps> = ({
  ...
  useEffect(() => {
    if (selectedFuelStand) {
      formik.setFieldValue('id', selectedFuelStand.id || '')
      formik.setFieldValue('expenseType', selectedFuelStand.expenseType || '')
      formik.setFieldValue('expenseDate', selectedFuelStand.expenseDate || '')
      formik.setFieldValue('amount', selectedFuelStand.amount || '')
      formik.setFieldValue('notes', selectedFuelStand.notes || '')
    }
  }, [selectedFuelStand])
            ...
            <div className='col-md-6 mb-3'>
              ...
              {formik.touched.expenseType && formik.errors.expenseType && (
                <div className='invalid-feedback'>
                  {t('validation.required', {name: t('fuelStand.fuelStand')})}
                </div>
              )}
            </div>
