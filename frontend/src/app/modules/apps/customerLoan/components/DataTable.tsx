...
import { CustomerLoanForm } from './_module'
import { getCustomerLoan } from '../../../../../redux/slices/customerLoan/CustomerLoanSlice'

const SORT_ASC = 'asc'
const SORT_DESC = 'desc'

const DataTable: React.FC<any> = ({ headers, columns, reload, handleEdit }) => {
  const [data, setData] = useState<CustomerLoanForm[]>([])
  ...
  useEffect(() => {
    ...
    dispatch(getCustomerLoan(params)).then((res) => {
