...
import CustomerLoanModal from './CustomerLoanModal'
...
const CustomerLoanList = () => {
  ...
  const openEditModal = (CustomerLoan: any) => {
    setSelectedCustomerLoan(CustomerLoan)
        ...
        <div className='card mb-5 mb-xl-10' id='kt_profile_details_view'>
          <div className='card-header cursor-pointer'>
            <div className='card-title m-0'>
              <h3 className='fw-bolder m-0'>
                ...
                {t('global.list', { name: t('customerLoan.customerLoans') })}
              </h3>
            </div>
            <div>
              <div className='d-none d-lg-flex mt-5'>
                <div className='d-flex align-items-center'>
                  ...
                  >
                    ...
                    {t('global.add', { name: t('customerLoan.customerLoans') })}
                  </button>
          ...
          <div className='card-body p-9 table-responsive'>
            <DataTable
              ...
              columns={['id', 'name', 'balance', 'phoneNumber', 'address']}
