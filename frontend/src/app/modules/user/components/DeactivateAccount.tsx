    ...
    <div className='card'>
      ...
      >
        <div className='card-title m-0'>
          <h3 className='fw-bolder m-0'>{intl.formatMessage({id: 'ACCOUNT.DEACTIVATE.TITLE'})}</h3>
        </div>
      </div>
      ...
      <div id='kt_account_deactivate' className='collapse show'>
        <form onSubmit={formik.handleSubmit} id='kt_account_deactivate_form' className='form'>
          ...
          <div className='card-footer d-flex justify-content-end py-6 px-9'>
            ...
            >
              {!loading && intl.formatMessage({id: 'ACCOUNT.DEACTIVATE.BUTTON_LABEL'})}
              {loading && (
                <span className='indicator-progress' style={{display: 'block'}}>
                  {intl.formatMessage({id: 'ACCOUNT.DEACTIVATE.LOADING_MESSAGE'})}{' '}
