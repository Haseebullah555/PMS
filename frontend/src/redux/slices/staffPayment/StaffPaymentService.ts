...
const getStaffSalaries = async (params: any) => {
  const response = await axiosInterceptor.get(`/StaffPayment/list`, {params})
...
const store = async (formData: any) => {
  ...
  const response = await axiosInterceptor.post('/StaffPayment/create', formData)
  return response.data
}

const update = async (formData: any) => {
  const response = await axiosInterceptor.post('/StaffPayment/update', formData)
  return response.data
}
