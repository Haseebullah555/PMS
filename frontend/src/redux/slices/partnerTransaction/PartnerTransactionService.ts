...
const getPartnerTransactions = async (params: any) => {
  const response = await axiosInterceptor.get(`/PartnerTransaction/list`, {params})
...
const store = async (formData: any) => {
  ...
  const response = await axiosInterceptor.post('/PartnerTransaction/create', formData)
  return response.data
}

const update = async (formData: any) => {
  const response = await axiosInterceptor.post('/PartnerTransaction/update', formData)
  return response.data
}
